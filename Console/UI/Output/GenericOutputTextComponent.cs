...
{
    [Serializable]
    public class GenericOutputTextComponent<T> : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerMoveHandler, IPointerClickHandler where T : Enum
    {
